...
public class quiz_view {
    ...
    void initialize() throws Exception {
        Platform.runLater(() -> {
            ...
            try {
                URL view_path = getClass().getResource("/com/ss/studysystem/Fxml/quiz/question.fxml");
                Region view_region = new FXMLLoader(view_path).load();
                quiz_root.getChildren().add(view_region);

                URL aview_path = getClass().getResource("/com/ss/studysystem/Fxml/quiz/shot_answer_view.fxml");
