...
public class User_Profile_Setting {
    @FXML
    ...
    void initialize(){
        try{
            URL path = getClass().getResource("/com/ss/studysystem/Fxml/Profile/Theme.fxml");
            ...
            URL path1 =getClass().getResource("/com/ss/studysystem/Fxml/Profile/Setting_view.fxml");
